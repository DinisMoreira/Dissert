...
class AbstractEnv(gym.Env):
    ...
    def get_available_actions(self):
        ...
        if not isinstance(self.action_type, DiscreteMetaAction):
            #print("AVAILABLE CONTINUOUS ACTIONS")
            return self.get_available_continuous_actions()
        ...
        #print("AVAILABLE DISCRETE ACTIONS:")
        #print(actions)
        return actions

    def get_available_continuous_actions(self):
        num_longitudinal_intervals = 10
        num_lateral_intervals = 15
        available_actions = []

        for longitudinal in range(num_longitudinal_intervals + 1):
            for lateral in range(num_lateral_intervals + 1):
                longitudinal_value = longitudinal*2/num_longitudinal_intervals -1
                lateral_value = lateral*2/num_lateral_intervals -1
                available_actions.append([longitudinal_value, lateral_value])
