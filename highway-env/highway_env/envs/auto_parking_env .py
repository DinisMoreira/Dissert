...
class AutoParkingEnv(AbstractEnv, GoalEnv):
    """
...
class AutoParkingEnvActionRepeat(AutoParkingEnv):
    def __init__(self):
...
register(
    id='auto_parking-v0',
    entry_point='highway_env.envs:AutoParkingEnv',
)

register(
    id='auto_parking-ActionRepeat-v0',
    entry_point='highway_env.envs:AutoParkingEnvActionRepeat'
)