...
class RoadObject(ABC):
    ...
    def to_dict(self, origin_vehicle=None, observe_intentions=True):
        d = {
            ...
            'path_long_dist': 0,
            'next_path_dist': 0,
            'cos_next_path_ang_diff': 1,
            'sin_next_path_ang_diff': 0,
            'next_path_long_dist': 0,
            'next_next_path_dist': 0,
            'cos_next_next_path_ang_diff': 1,
            'sin_next_next_path_ang_diff': 0,
            'next_next_path_long_dist': 0,
            'next_next_next_path_dist': 0,
            'cos_next_next_next_path_ang_diff': 1,
            'sin_next_next_next_path_ang_diff': 0,
            'next_next_next_path_long_dist': 0
        }
